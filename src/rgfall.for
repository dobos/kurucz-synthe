...
c     1 mA = 0.0001 nm 
      ...
      WLVAC=ABS(WL)+DWL
      IF(IFVAC.EQ.1.OR.LABELP(1).EQ.'CONTINUU')WLVAC=
...
C     DELELO=POTION(NELION)-ELO
      ...
      RSQLO=0.
      ENDIF
      IF(LABELP(1).EQ.'CONTINUU')RSQLO=0.
...
C     TYPE.GT.3 = NLAST  CONTINUUM
      ...
      IF(LABELP(1).EQ.'CONTINUU')NLAST=XJP
      IF(LABELP(1).EQ.'CONTINUU')GF=GF*(XJ+XJ+1.)
      NCON=0
...
C     GR IS GAUNT FACTOR FOR CORONAL LINES
 ...
 1253 WRITE(19)WLVAC,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,
     1GAMMAR,GAMMAS,GAMMAW,ALPHABAR,NBUFF,LIM,LANDE,LANDEP
...
C     WRITE(6,5555)WLVAC,ILINE
 5555 FORMAT(112X,F10.4,I10)
      GO TO 900
C     PLAIN LINE
 1260 WRITE(12)NBUFF,CGF,NELION,ELO,GAMMAR,GAMMAS,GAMMAW,ALPHABAR,
     1 LANDE,LANDEP
...
C      IF(IFNLTE.EQ.1)N19=0
     ...
     1WLBEG,WLEND,RESOLU,RATIO,RATIOLG,CUTOFF,LINOUT
      ...
      END
      SUBROUTINE IONPOTS
c     21Jun17  John Lester corrects typo in Ni
C
...
C    21Jun17 John Lester                           3000.D0
C    4   14180000.D0, 15170000.D0, 16196000.D0,1718300.D0,18515000.D0,
